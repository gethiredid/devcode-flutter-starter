...
8. Selesaikan challenge yang terdapat pada file `lib/modules/hello/hello_view.dart`, `lib/modules/retrieve_data/retrieve_data_controller.dart`, `lib/modules/retrieve_data/retrieve_data_view.dart`
